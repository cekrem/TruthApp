...
namespace g{struct FlipApp_FuseControlsPageControl_ActiveIndex_Property;}
...
struct FlipApp_FuseControlsPageControl_ActiveIndex_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::PageControl*> _obj;

    void ctor_3(::g::Fuse::Controls::PageControl* obj, ::g::Uno::UX::Selector name);
    static FlipApp_FuseControlsPageControl_ActiveIndex_Property* New1(::g::Fuse::Controls::PageControl* obj, ::g::Uno::UX::Selector name);
};
// }
